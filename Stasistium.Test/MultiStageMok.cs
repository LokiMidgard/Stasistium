...
//            return Task.FromResult(this.Context.CreateStageResultList(list, hasChanges, this.Current.Select(x => x.id).ToImmutableList(), this.Current, this.Context.GetHashForObject(list.Select(x => x.Hash))));
//        }
//    }
//}
